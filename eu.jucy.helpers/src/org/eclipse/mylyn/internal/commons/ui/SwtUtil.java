...
public class SwtUtil {
	...
	public static FadeJob fastFadeIn(Shell shell, IFadeListener listener,float percent) {
		return new FadeJob(shell, (int)(percent*4 * FADE_IN_INCREMENT), FADE_RESCHEDULE_DELAY, listener);
	}
	...
	public static FadeJob fadeOut(Shell shell, IFadeListener listener,float percent) {
		return new FadeJob(shell,(int)(percent* 2*FADE_OUT_INCREMENT), FADE_RESCHEDULE_DELAY, listener);
	}
